...
### Moved out — reader subagent

The delegated reader loop ("go find X across sources", own throwaway
context) is now plan 056 (subagent capability), which builds the isolated
subagent primitive it needs. Escalation ladder stays: page it yourself (01)
→ single-doc Haiku query (02) → reader subagent (056).
...
- Reader subagent → moved to plan 056
