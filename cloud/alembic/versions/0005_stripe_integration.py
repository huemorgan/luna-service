...
def upgrade() -> None:
    ...
    sa.Column('disputed_pretax_cents', sa.BigInteger(), nullable=False),
    ...
    sa.CheckConstraint('disputed_pretax_cents >= 0 AND disputed_pretax_cents <= pretax_amount_cents', name='ck_sp_dispute_bounds'),
    sa.ForeignKeyConstraint(['account_id'], ['billing_accounts.account_id'], ondelete='RESTRICT'),
