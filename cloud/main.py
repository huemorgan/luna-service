...
async def lifespan(app: FastAPI):
    ...
    if os.environ.get("CLOUD_BILLING_WORKER", "1") == "1":
        ...
        import cloud.billing.simulator  # noqa: F401 — registers pricing_sim handler
        from cloud.billing.maintenance import maintenance_loop
        from cloud.billing.operations import ops_loop
        ...
        async def billing_loop() -> None:
            ...
            # expiry / scheduled lots / hosting renewals (039/005) + ops alert
            # evaluation (039/009) share the single-worker advisory lock.
            await asyncio.gather(
                ...
                ops_loop(billing_session_factory),
            )
